                 ...
                 <div className="space-y-6">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {['JavaScript (ES6+)', 'TypeScript', 'HTML5', 'CSS3', 'Python'].map(skill => (
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {['React', 'Next.js', 'Vue', 'Tailwind', 'Framer Motion', 'Node.js'].map(skill => (
                           <span key={skill} className="px-3 py-1 bg-white/5 text-xs rounded border border-white/5 text-gray-300 hover:text-white hover:border-primary/50 transition-colors">
                            {skill}
                          </span>
                        ))}
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {['Git', 'Figma', 'Docker', 'AWS', 'VS Code'].map(skill => (
                           <span key={skill} className="px-3 py-1 bg-white/5 text-xs rounded border border-white/5 text-gray-300 hover:text-white hover:border-primary/50 transition-colors">
                            {skill}
                          </span>
                        ))}
                ...
                <div className="p-6 space-y-4 text-gray-300">
                   ...
                   <div className="pl-4 space-y-3 pt-2">
                      <p className="flex gap-3">
                        <span className="text-primary whitespace-nowrap">[2023_Q4]</span> 
                        <span>Awarded "Top Contributor" at Global React Conference.</span>
                      </p>
                      <p className="flex gap-3">
                        <span className="text-primary whitespace-nowrap">[2023_Q2]</span> 
                        <span>Successfully migrated legacy monolith to micro-services for Client X.</span>
                      </p>
                      <p className="flex gap-3">
                        <span className="text-primary whitespace-nowrap">[2022_Q3]</span> 
                        <span>Published "The Modern CSS Stack" - featured on Hacker News.</span>
                      </p>
                      <p className="flex gap-3">
